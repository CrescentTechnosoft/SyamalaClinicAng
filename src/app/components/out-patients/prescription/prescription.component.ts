...
export class PrescriptionComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.dosages =  ['ST','BD','SOS','OD','TDS','QID','HS']
    ...
    this.service.GetAll()
      ...
      .then(d => {
        ...
        this.service.dosage.push(...this.dosages);
  ...
  savePrescription(): void {
    if (this.inputs.year === '')
      ...
      this.service.savePrescription(
        {
          data: this.inputs,
          complaints: this.inputs.complaint,
    ...
    if (this.inputs.prYear !== '' && this.inputs.prId !== '') {
      this.service.getPrescriptions(this.inputs.prId)
        ...
        .then(d => {
          ...
          this.inputs.temp = d.data.temp,
          this.inputs.spo2 = d.data.spo2,
          this.inputs.past= d.data.past,
          this.inputs. allergies= d.data.allergies,
          this.inputs.general= d.data.general,
          this.inputs.complaint = d.data.complaint,
          this.inputs.rbs = d.data.rbs
          this.inputs.treatment = d.data.treatment
