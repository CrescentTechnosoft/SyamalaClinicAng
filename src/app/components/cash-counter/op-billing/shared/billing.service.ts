...
import { Inputs, Response,ResponseData, TempData, Patient, FeesData, BillNo, Mail } from './opbilling.model';
...
export class BillingService {
    ...
    sendBill(ptid){
        return this.http.post(`${this.extrasUrl}sendBill/${ptid}`,
        {
            responseType: 'text'
        });
    }
    sendOldBill(billNumber):Observable<any>{
        return this.http.post(this.extrasUrl + 'sendOldBill/'+billNumber,{
            responseType: 'text'
        });
    }
    GetInputs(): Inputs {
